...
namespace GameShareManager.Helpers
{
    ...
    {
        public static void MapLocalizedMvcAttributeRoutes(this RouteCollection routes, string urlPrefix,
            object constraints)
        {
            ...
            RouteValueDictionary constraints)
        {
            ...
            FieldInfo subRoutesInfo =
                routeCollectionRouteType.GetField("_subRoutes", BindingFlags.NonPublic | BindingFlags.Instance);
